  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'glow-cyan': '0 0 20px hsl(var(--syntax-cyan) / 0.4)',
        'glow-orange': '0 0 20px hsl(var(--syntax-orange) / 0.4)',
        'glow-green': '0 0 20px hsl(var(--syntax-green) / 0.4)',
        'glow-purple': '0 0 20px hsl(var(--syntax-purple) / 0.4)',
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
